...
//	virtual void Draw() const =0; //순수 가상함수 pure virtual function => 추상클래스가됨/ 자기자신 구현부분 없어도됨
//
//	Shape();
...
///*
//virtual(가상 함수)
//1. virtual 리턴타입 함수이름 {함수바디}; [가상함수]
//2. virtual 리턴타입 함수이름() const=0;  [순수 가상함수]
// => 추상클래스가됨/ 자기자신 구현부분 없어도됨
//
//
//*/
//int main() {
